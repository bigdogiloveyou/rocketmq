...
public class MQClientAPIImpl {
    ...
    /**
     * 拉取消息，根据 consumer 消费的方式进行拉取，方式有：ONEWAY、ASYNC、SYNC
     * @param addr
     * @param requestHeader
     * @param timeoutMillis
    ...
    /**
     * 根据 consumer 组获取 consumer id 集合
     * @param addr broker 地址
     * @param consumerGroup consumer 组
     * @param timeoutMillis 超时时间
     * @return
